...
<section class="layaout__resetPasswordConfirma--bg"></section>
	<section class="layaout__resetPasswordConfirma">
		<article class="row text-center">
			<section class="small-12 medium-8 large-8 columns small-centered padding-no"> <!--nuevo-->
				...
				<p class="paragraph white">
					Te enviamos un link a tu email inscrito para que puedas activar tu cuenta <strong class="text__colour--1">puede tardar algunos minutos en llegarte el email. También puedes verificar tu carpeta de spam</strong>
				</p>
